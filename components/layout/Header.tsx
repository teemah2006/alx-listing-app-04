...
const Header = () => {
    return (
        <div className="w-full flex flex-col space-y-2 sticky top-0 z-10 bg-white pb-4">
            <header className=" w-full border-b border-gray-300 lg:px-10 md:px-8 px-4 py-4   flex justify-between items-center">
